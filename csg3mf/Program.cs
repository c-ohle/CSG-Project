  ...
  class AnyForm : UIForm
  {
    ...
    void Open(string path)
    {
      ...
      if (script != null)
      {
        ...
        var edit = (ScriptEditor)ShowView(typeof(ScriptEditor), cont, DockStyle.Left, ClientSize.Width / 2);
        edit.Text = "Script"; Neuron.Debugger = (p, v) => (this.edit = edit.edit).Show(v);
      }
    ...
    protected override int OnCommand(int id, object test)
    {
      switch (id)
      {
        ...
        case 1120: if (test == null) ShowView(typeof(Xml3mfView), cont, DockStyle.Fill); return 1;
      }
    ...
    unsafe int OnSave(object test, bool saveas)
    {
      ...
      view.IsModified = false; if (edit != null) edit.IsModified = false; Cursor.Current = Cursors.Default;
      return 1;
    }
    ...
    bool AskSave()
    {
      ...
      if ((edit == null || !edit.IsModified) && !view.IsModified) return true;
      switch (MessageBox.Show(this, String.Format(path == null ? "Save changings?" : "Save changings in {0}?", path), Application.ProductName, MessageBoxButtons.YesNoCancel, MessageBoxIcon.Exclamation))
      {
        ...
        case DialogResult.Yes: OnCommand(1020, null); return (edit == null || !edit.IsModified) && !view.IsModified;
      }
      return false;
    }
    protected override void OnFormClosing(FormClosingEventArgs e)
    {
      if (e.Cancel = !AskSave()) return; edit?.OnFormClosing(this);
      var reg = Application.UserAppDataRegistry;
    ...
    class ScriptEditor : UserControl, IComparable<(int id, object test)>
    {
      int IComparable<(int id, object test)>.CompareTo((int id, object test) p)
      {
        if (p.id == 0) { MenuItem.Update(tb.Items); tb.Update(); } //ui
        return edit.OnCommand(p.id, p.test);
      }
      ...
      protected override void OnLoad(EventArgs e)
      {
        ...
        Visible = false; edit.Tag = Tag; Controls.Add(edit); Controls.Add(tb); Visible = true;
      }
    }
    class Xml3mfView : XmlEditor
    {
      protected override void OnHandleCreated(EventArgs e)
      {
        Text = "3MF Content";
        var cont = (Container)Tag;
        var el = cont.Export3MF(null, null, null, null);
        EditText = el.ToString();
